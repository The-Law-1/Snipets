<template>
  <div class="min-h-screen bg-gray-50 p-6">
    <div class="max-w-2xl mx-auto">
      ...
      <SearchBar @search="onSearch" placeholder="Search articles by title..." />
      ...
      <div v-if="articles.length > 0" class="grid gap-6 mt-6">
        <ArticleCard v-for="article in articles" :key="article.id" :article="article" @expand="onExpandArticle" />
      </div>
    </div>
  </div>
</template>
